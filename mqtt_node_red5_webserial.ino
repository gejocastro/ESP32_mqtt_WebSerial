// ESP32 sending data to NODE-RED via MQTT.
// WebSerial server sends selected data vie web replicating Serial Monitor messages.
//gejocastro - may/22
//
...
// Callback para recepcion de datos desde cliente web
